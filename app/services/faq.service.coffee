...
FaqService = () ->
  questions = [{
    ...
    }
    {
      ...
      overflowedAnswer: 'Swiftoberfest 2015 t-shirt: The first 200 members to complete the Show Your Skills challenge and earn the Swift/iOS Ready! badge automatically win a Swiftoberfest 2015 t-shirt. Winners will be contacted...'
    }
  ]
